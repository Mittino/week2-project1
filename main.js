...
var me = {
  name:'Anna',
  city:'Boulder',
  jobTitle:'Region Administration Manager',
};
...
me.family = (['Dan','Steve', 'Becca', 'Alli']);
console.log(me);
...
var dinnerString =('Lauren\'s appetizer is '+ invitees.adults[2].dinnerChoice[0] + '. She will be eating ' + invitees.adults[2].dinnerChoice[1] + ' for dinner and has selected ' + invitees.adults[2].dinnerChoice[2] + ' as her dessert.');
...
ISBN22222: {
  title: 'Hot Diggity',
  author: 'Snoop Doggy Dog',
  pages: 55
  },

ISBN33333: {
  title: 'It\'s All Sunshine, Butterflies, and Rainbows',
  author: 'Sunshine High',
  pages: 55
  },
}
...
console.log(books.ISBN11111.author);
...
books.ISBN11111.dateRead = 'January 1, 2005'
books.ISBN22222.dateRead = 'April 15, 2015'
books.ISBN33333.dateRead = 'February 14, 2000'
console.log(books.ISBN11111.dateRead);
...
//In Literal Notation you literally write out each object and it's prperties. In Constructor Notation you create the object, and then add to it.
